                        ...
                        <div class="row">   
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group ">                                   
                                        <label for="email" >Email :</label>
                                            <input class="form-control" type="email" name="email" id="email" placeholder="Email" ng-model="user.email" required/>
                                    ...
                                    <div class="form-group">                                   
                                        ...
                                        <input class="form-control" type="text" name="phone"  ng-model="user.phone" placeholder="Phone " ng-minlength="10" ng-maxlength="10"  required>
                                ...
                                <div class="col-md-5 col-md-offset-1">
                                    ...
                                    <div class="form-group">                                   
                                        ...
                                        <input class="form-control" type="date" name="dob" id="" ng-model="user.dob">
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="col-md-3 col-sm-offset-3" style="margin-top:2%" >
                                    <button class="btn  btn-primary" type="submit" name="addcontact" ng-click="addcontact(user);">Add Contact</button>
                                </div>
                            </div>
                            <div class="form-group text-center">
